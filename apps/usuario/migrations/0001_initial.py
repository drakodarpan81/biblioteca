# Generated by Django 4.0.2 on 2022-04-16 20:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=254, unique=True, verbose_name='Correo Electornico')),
                ...
                ('usuario_activo', models.BooleanField(default=True, verbose_name='Usuario Activo/Inactivo')),
                ('usuario_administrador', models.BooleanField(default=False, verbose_name='Admin Activo/Inactivo')),
            ],
            options={
                'abstract': False,
            },
